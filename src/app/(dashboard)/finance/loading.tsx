  ...
  return (
    <div className="animate-pulse p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <div className="h-8 w-24 rounded bg-[var(--color-bg-secondary)]" />
          <div className="mt-2 h-4 w-48 rounded bg-[var(--color-bg-secondary)]" />
        </div>
      ...
      <div className="mb-4 flex gap-3">
        <div className="h-10 w-32 rounded-[var(--radius-sm)] bg-[var(--color-bg-secondary)]" />
        <div className="h-10 w-32 rounded-[var(--radius-sm)] bg-[var(--color-bg-secondary)]" />
      </div>
