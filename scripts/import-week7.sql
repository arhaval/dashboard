-- HAFTA 7 VERİLERİ - CS2 TURNUVA
-- Tarih: 2026-04-28
-- 3 oynandı: GEGEN vs BUSC, MAMBA vs SIKLA, CRIMSON vs BORU
-- 2 takım (AK47, HIZAL) BAY geçti

BEGIN;

-- 1) İki elenen takım arasındaki bogus maçı ve diğer placeholder pending maçları temizle
...
BEGIN
  ...
  -- ==========================================
  -- MATCH 1: GEGENPRES 3-0 BusCourney
  -- Map1: dust2 13-2 (15r) | Map2: inferno 13-5 (18r) | Map3: anubis 13-5 (18r)
  -- Toplam: 51 round
  -- Altar 2 map, Vendetta 1 map, diğerleri 3 map
  -- ==========================================
  INSERT INTO cs2_matches (team1_id, team2_id, status, match_date, winner_team_id, team1_maps_won, team2_maps_won)
  VALUES (t_gegen, t_busc, 'FINISHED', '2026-04-28', t_gegen, 3, 0)
  ...
  -- Altar 2 map oynadı (14 + 18 = 32 round hesabı - maps 2 ve 3'te oynadı dust2 hariç)
  -- Aslında CSV'lerde map 14 ve 15'te var, map 13'te yok. Demek 2 map (inferno+anubis) 18+18=36 round
  ...
  -- Vendetta 1 map (sadece map 13 = dust2) → 15 round
  ...
  -- ==========================================
  -- MATCH 2: SIKLATANLAR 3-0 BLACK MAMBA
  -- Map1: dust2 13-1 (14r) | Map2: mirage 13-3 (16r) | Map3: ancient 13-3 (16r)
  -- Toplam: 46 round
  -- ==========================================
  INSERT INTO cs2_matches (team1_id, team2_id, status, match_date, winner_team_id, team1_maps_won, team2_maps_won)
  VALUES (t_sik, t_mamba, 'FINISHED', '2026-04-28', t_sik, 3, 0)
  ...
  -- SIKLATANLAR oyuncuları (3 map, 46 round)
  ...
  -- ==========================================
  -- MATCH 3: CRIMSON REAPERS 3-0 Börü
  -- Map1: dust2 13-3 (16r) | Map2: nuke 13-7 (20r) | Map3: ancient 13-9 (22r)
  -- Toplam: 58 round
  -- ==========================================
  INSERT INTO cs2_matches (team1_id, team2_id, status, match_date, winner_team_id, team1_maps_won, team2_maps_won)
  VALUES (t_crimson, t_boru, 'FINISHED', '2026-04-28', t_crimson, 3, 0)
  ...
  RAISE NOTICE '7. Hafta import tamamlandı: GEGEN 3-0 BUSC, SIKLA 3-0 MAMBA, CRIMSON 3-0 BORU';
END $$;
